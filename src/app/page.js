      ...
      <div className="grid gap-8 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter your domain and port to generate an Nginx configuration
              file.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Edit the configuration if needed and download the file.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Textarea
              className="min-h-[400px] font-mono text-sm"
              placeholder="Your Nginx configuration will appear here..."
              value={config}
